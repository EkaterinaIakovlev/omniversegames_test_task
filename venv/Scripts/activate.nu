...
def-env activate-virtualenv [] {
    ...
    let virtual_env = 'C:\Users\Katya\PycharmProjects\omniversegames_test_task\venv'
    let bin = 'Scripts'
    let path_sep = ';'
...
alias deactivate = source 'C:\Users\Katya\PycharmProjects\omniversegames_test_task\venv\Scripts\deactivate.nu'
